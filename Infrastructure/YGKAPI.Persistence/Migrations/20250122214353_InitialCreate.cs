        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    APIClientId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    DateCreated = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientMenus_APIClients_APIClientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DbCredentials_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Path = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ClientEndpointMenuId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    DateCreated = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientEndpoints_ClientMenus_ClientEndpointMenuId",
                        column: x => x.ClientEndpointMenuId,
                        principalTable: "ClientMenus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                name: "AppRoleClientEndpoint",
                columns: table => new
                {
                    ClientEndpointsId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    RolesId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppRoleClientEndpoint", x => new { x.ClientEndpointsId, x.RolesId });
                    table.ForeignKey(
                        name: "FK_AppRoleClientEndpoint_AspNetRoles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppRoleClientEndpoint_ClientEndpoints_ClientEndpointsId",
                        column: x => x.ClientEndpointsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppRoleClientEndpoint_RolesId",
                table: "AppRoleClientEndpoint",
                column: "RolesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientEndpoints_ClientEndpointMenuId",
                table: "ClientEndpoints",
                column: "ClientEndpointMenuId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientMenus_APIClientId",
                table: "ClientMenus",
                column: "APIClientId");

            migrationBuilder.CreateIndex(
                name: "IX_DbCredentials_UserId",
                table: "DbCredentials",
                column: "UserId");
